    ...
    await queryInterface.bulkInsert('WinterMonsters', [
      {
        ...
        attacks: JSON.stringify([
          { name: 'Snow Bombs', description: 'Light physical damage.' },
          {
            name: 'Frosty Laugh',
            description: 'Reduces your strength temporarily.',
          },
          { name: 'Icy Punch', description: 'Basic physical attack.' },
        ]),
        flavorText: 'A mischievous clown who throws snowballs at everyone!',
      },
      {
